...
function GemCircle() {
  return (
    ...
    <div className=" md:w-2/3 font-normal lead-[30px] text-[28px] font-fInter">Gemcircle in partnership with EnetPad will breed the finest project in the crypto space.</div>
